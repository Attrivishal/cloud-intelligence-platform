      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            Automated analysis of your resources to find security vulnerabilities, misconfigurations, and idle assets. We evaluate instances for low CPU utilization, high memory consumption, and exposure risks.
          </p>
        </motion.section>
