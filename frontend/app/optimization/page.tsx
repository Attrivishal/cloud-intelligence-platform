      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            Transform findings into action. Our engine provides contextual recommendations to right-size instances, terminate unused resources, and utilize more cost-effective instance families.
          </p>
        </motion.section>
