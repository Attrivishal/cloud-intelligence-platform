...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0A1929] overflow-hidden relative">
      ...
      <button
        onClick={() => router.push("/")}
        className="absolute top-8 left-8 z-20 flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all duration-300 group"
      >
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex gap-1 h-1">
                <div className="flex-1 h-full bg-white/20 rounded-full"></div>
                <div className="flex-1 h-full bg-white/20 rounded-full"></div>
                <div className="flex-1 h-full bg-white/20 rounded-full"></div>
                <div className="flex-1 h-full bg-white/20 rounded-full"></div>
              </div>
            ...
            <div className="flex items-start gap-3">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 rounded border-white/20 bg-white/10 text-[#4A6FA5] focus:ring-[#4A6FA5]/50"
                required
              />
              <label htmlFor="terms" className="text-xs text-gray-300">
                I agree to the{" "}
                <Link href="/terms" className="text-[#5B7AB5] hover:text-[#4A6FA5] transition">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="text-[#5B7AB5] hover:text-[#4A6FA5] transition">
                  Privacy Policy
                </Link>
              </label>
            </div>
