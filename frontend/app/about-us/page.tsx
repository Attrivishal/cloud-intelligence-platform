...
import { Cloud, ArrowLeft, Users } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            CloudIntel began as a capstone initiative to build a transparent, developer-focused FinOps tool. Our vision is to demystify complex billing and provide real infrastructure observability.
          </p>
        </motion.section>
