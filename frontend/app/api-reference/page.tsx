...
import { Cloud, ArrowLeft, FileCode2 } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            Detailed documentation for developers looking to integrate with our FastAPI backend. Explore endpoints for retrieving instance metadata, updating cost reports, and manually triggering sync tasks.
          </p>
        </motion.section>
