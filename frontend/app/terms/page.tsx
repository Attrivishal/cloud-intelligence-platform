      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            By utilizing this platform, you agree to our terms. The tool is provided as open-source software without guarantees. Always verify recommendations before executing changes in your AWS console.
          </p>
        </motion.section>
