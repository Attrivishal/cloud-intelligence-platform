...
import { Cloud, ArrowLeft, Cpu } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            Our platform provides comprehensive, real-time visibility into your AWS infrastructure. Syncing via Boto3, we pull detailed metadata about your EC2 instances, S3 buckets, RDS databases, and Lambda functions to give you an unfiltered view of your multi-account environment.
          </p>
        </motion.section>
