...
import { Cloud, ArrowLeft, BarChart3 } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            Advanced ML models analyze your usage patterns to precisely forecast future cloud expenditures. Track daily spend across services and regions to eliminate waste before it happens.
          </p>
        </motion.section>
