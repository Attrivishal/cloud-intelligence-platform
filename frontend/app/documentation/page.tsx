...
import { Cloud, ArrowLeft, BookOpen } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <div className="w-24 h-24 rounded-3xl bg-white/5 flex items-center justify-center mx-auto mb-8">
            <BookOpen className="w-12 h-12 text-[#5B7AB5]" />
          </div>
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            Explore our comprehensive guides to learn how to connect your AWS accounts securely, configure synchronization schedules, and interpret dashboard analytics.
          </p>
        </motion.section>
