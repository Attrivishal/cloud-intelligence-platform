      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            We commit to strict data handling practices. AWS metadata is securely processed locally and never sold to third parties. We collect only what is explicitly necessary for generating analytics.
          </p>
        </motion.section>
