      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <div className="w-24 h-24 rounded-3xl bg-white/5 flex items-center justify-center mx-auto mb-8">
            <HelpCircle className="w-12 h-12 text-teal-400" />
          </div>
        ...
        >
          <p className="text-gray-400 text-xl leading-relaxed">
            Search our knowledge base for FAQs regarding AWS connectivity, Boto3 integration errors, or dashboard troubleshooting steps.
          </p>
        </motion.section>
